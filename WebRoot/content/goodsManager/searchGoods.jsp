		...
		<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0>
			<TBODY>
				<TR class="bg_header" height=47>
					...
					<TD><SPAN class="main_hl2"></SPAN> <SPAN class="main_hb">商品查询
						...
						<DIV>
							<TABLE class=gridView
								...
								<TBODY>
									...
									<TR>
										<form action="<%=path%>/servlet/ScanGoodServlet"
											method="post">
											<TD>&nbsp;&nbsp;&nbsp;商品Id &nbsp;&nbsp;&nbsp; <input
												class=gridViewItem type="text" name="productID">
												&nbsp;&nbsp;&nbsp;商品名称 &nbsp;&nbsp;&nbsp; <input
												class=gridViewItem type="text" name="productName">
									...
									<TR>
										<td>
											<div id="pagination">
												<table class=gridView
													style="WIDTH: 100%; BORDER-COLLAPSE: collapse" width="90%"
													...
													<c:forEach items='${goods }' var='goodss'>
														<TR>
															...
															<TD class=gridViewItem><A class=cmdField
																href="EditDelGoodsServlet?goodsid=${goodss.id}">编辑</A></TD>
															<TD class=gridViewItem><a class=cmdField
																href="EditDelGoodsServlet?goodsid=${goodss.id}&op=del">删除
															</a></TD>
														</TR>
													</c:forEach>
												</table>
