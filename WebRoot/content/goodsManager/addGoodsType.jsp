            ...
            <TABLE class=gridView style="WIDTH: 80%; BORDER-COLLAPSE: collapse"  cellSpacing=0 rules=all  border=1>
              <TBODY>
                ...
                <TR>
                  ...
                  <input class=gridViewItem type="text" name="typeID"><span id="idError"></span></TD>
                  <TD class=gridViewItem>类别名称&nbsp;<font color=red>*</font></TD>
                  <TD class=gridViewItem>
                  
                  <input  class=gridViewItem type="text" name="typeName"><span id="nameError"></span></TD>
                </TR>
               <TR>
                  <TD class=gridViewItem >类别描述 </TD>
                  <TD class=gridViewItem colspan="3">
                  
                  <input size="100" class=gridViewItem type="text" name="typeDec"></TD>
                </TR>
                <TR>
